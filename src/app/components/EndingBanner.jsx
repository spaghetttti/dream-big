  ...
  return (
    <>
      ...
      <div className="block px-4 mb-2 text-center text-l md:text-2xl font-bold text-red-800">
        You can all us at (630) 566-2272, email us at{" "}
        <a href="mailto: hr@dreambtransporting.com">
          hr@dreambtransporting.com{" "}
        </a>{" "}
        <br />
        or visit our physical address at{" "}
        <Link
          className="underline"
          href="https://www.google.com/maps/place/3030+Warrenville+Rd+450+09,+Lisle,+IL+60532,+USA/data=!4m2!3m1!1s0x880e5695deb7ad53:0xa4b44fdbfbde7fa?sa=X&ved=2ahUKEwij56OX6YKDAxUmV6QEHfWdCoMQ8gF6BAghEAA"
        >
