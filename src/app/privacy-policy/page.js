// Файл: app/privacy-policy/page.js
  ...
  return (
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            {/* Обратите внимание: я обновил дату на текущую. Убедитесь, что она верна. */}
            <strong>Last updated: June 18, 2025</strong>
          </p>
          <p>
          ...
          <ul>
            ...
            <li><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Dream Big Transportation INC, located at 3030 Warrenville Road Suite 450-09, Lisle, IL 60532. You can contact us at +1 (630) 566-2272.</li>
            <li><strong>Cookies</strong> are small files that are placed on Your computer...</li>
            ...
            <li><strong>Website</strong> refers to Dream Big Transportation INC, accessible from <a href="https://dreambtransporting.com/" target="_blank" rel="noopener noreferrer">https://dreambtransporting.com/</a></li>
          ...
          <h4>Usage Data</h4>
          <p>Usage Data is collected automatically when using the Service. Usage Data may include information such as Your Device’s Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers and other diagnostic data. When You access the Service by or through a mobile device, We may collect certain information automatically, including, but not limited to, the type of mobile device You use, Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique device identifiers and other diagnostic data. We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device. SMS opt-in or phone numbers for the purpose of SMS are not being shared with any third party and affiliate company for marketing purposes.</p>
          ...
          <h3>Google Places</h3>
          <p>Google Places is a service that returns information about places using HTTP requests. It is operated by Google. Google Places service may collect information from You and from Your Device for security purposes. The information gathered by Google Places is held in accordance with the Privacy Policy of Google: <a href="https://www.google.com/intl/en/policies/privacy/" target="_blank" rel="noopener noreferrer">Google Privacy Policy</a>.</p>
          ...
          <ul>
            <li>By phone number: +1 (630) 566-2272</li>
          </ul>
        </div>
      </div>
  );
