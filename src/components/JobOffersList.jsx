export const JobOffersList = () => {
  return (
    <div className="self-center flex w-full max-w-[1200px] flex-col mt-36 px-5 max-md:max-w-full max-md:mt-10">
      ...
      <div className="border self-stretch -mr-5 mt-36 border-solid border-red-800 max-md:max-w-full max-md:mt-10">
      ...
      <div className="text-orange-100 text-2xl font-bold leading-9 uppercase whitespace-nowrap items-center bg-red-800 self-center w-[235px] max-w-full mt-12 px-5 py-5 max-md:mt-10">
        Browse All
      </div>
    </div>
  );
